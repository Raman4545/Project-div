      ...
      <div className='top-contacts-part'>
        <div className='contact-information'>
          ...
          <ul className='c-i-ul'>
            ...
            <li className='c-i-li'><i class="fa-solid fa-phone icons icon-2"></i>+91 9829155269, +91 9829176249​</li>
            <li className='c-i-li'><i class="fa-solid fa-envelope icons icon-3"></i> arerkalyani@gmail.com</li>
            {/* Use an anchor tag for the LinkTree item */}
            <a className='a-tag' href='https://linktr.ee/arerkalyani' target='_blank' rel='noopener noreferrer'><li className='c-i-li'><i class="fa-solid fa-link icons icon-4"></i> LinkTree</li></a>
          </ul>
        </div>
